...
<html>
  <head>
    ...
    <!-- Bootstrap 3.3.2 -->
    <link href="<?php echo $this->config->base_url(); ?>assets/bootstrap/css/bootstrap.min.css" rel="stylesheet" type="text/css" />    
    <!-- FontAwesome 4.3.0 -->
    <link href="https://maxcdn.bootstrapcdn.com/font-awesome/4.3.0/css/font-awesome.min.css" rel="stylesheet" type="text/css" />
    <!-- Ionicons 2.0.0 -->
    <link href="http://code.ionicframework.com/ionicons/2.0.0/css/ionicons.min.css" rel="stylesheet" type="text/css" />    
    <!-- Theme style -->
    <link href="<?php echo $this->config->base_url(); ?>assets/adminlte/css/AdminLTE.min.css" rel="stylesheet" type="text/css" />
    <!-- AdminLTE Skins. Choose a skin from the css/skins 
         folder instead of downloading all of them to reduce the load. -->
    <link href="<?php echo $this->config->base_url(); ?>assets/adminlte/css/skins/_all-skins.min.css" rel="stylesheet" type="text/css" />
    <!-- iCheck -->
  ...
  <body class="skin-blue">
    <div class="wrapper">
      ...
      <header class="main-header">
        <!-- Logo -->
        <a href="index2.html" class="logo">Contatos</a>
          ...
          <div class="navbar-custom-menu">
            <ul class="nav navbar-nav">
                  ...
                  <li>
                    ...
                    <ul class="menu">
                      <li><!-- start message -->
                        <a href="#">
                          <div class="pull-left">
                            <img src="<?php echo $this->config->base_url(); ?>assets/adminlte/img/user2-160x160.jpg" class="img-circle" alt="User Image"/>
                          </div>
                          <h4>
                            Support Team
                      ...
                      <li>
                        <a href="#">
                          <div class="pull-left">
                            <img src="<?php echo $this->config->base_url(); ?>assets/adminlte/img/user3-128x128.jpg" class="img-circle" alt="user image"/>
                          </div>
                          <h4>
                      ...
                      <li>
                        <a href="#">
                          <div class="pull-left">
                            <img src="<?php echo $this->config->base_url(); ?>assets/adminlte/img/user4-128x128.jpg" class="img-circle" alt="user image"/>
                          </div>
                          <h4>
                            Developers
              ...
              <li class="dropdown user user-menu">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                  <img src="<?php echo $this->config->base_url(); ?>assets/adminlte/img/user2-160x160.jpg" class="user-image" alt="User Image"/>
          ...
          <ul class="sidebar-menu">
            ...
            <li class="active treeview">
              ...
              <ul class="treeview-menu">
                <li class="active"><a href="<?php echo base_url() ?>users/users"><i class="fa fa-circle-o"></i> Ver todos</a></li>
                <li><a href="<?php echo base_url() ?>users/users/insert"><i class="fa fa-circle-o"></i> Inserir</a></li>
              </ul>
            </li>
          </ul>
        </section>
    ...
    <!-- Bootstrap 3.3.2 JS -->
    <script src="<?php echo $this->config->base_url(); ?>assets/bootstrap/js/bootstrap.min.js" type="text/javascript"></script>    
    <!-- Morris.js charts -->
    ...
    <!-- AdminLTE App -->
    <script src="<?php echo $this->config->base_url(); ?>assets/adminlte/js/app.min.js" type="text/javascript"></script>

    <script src="<?php echo $this->config->base_url(); ?>assets/js/jquery.maskedinput.min.js" type="text/javascript"></script>
    <script src="<?php echo $this->config->base_url(); ?>assets/js/main.js" type="text/javascript"></script>
